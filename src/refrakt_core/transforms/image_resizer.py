...
class SmartImageResizer:
    ...
    def _resize_maintain_aspect(self, image: Image.Image, target_size: Tuple[int, int]) -> Image.Image:
    ...
    def _resize_crop(self, image: Image.Image, target_size: Tuple[int, int]) -> Image.Image:
    ...
    def _resize_pad(self, image: Image.Image, target_size: Tuple[int, int]) -> Image.Image:
    ...
    def _resize_stretch(self, image: Image.Image, target_size: Tuple[int, int]) -> Image.Image:
    ...
    def resize_tensor(
        ...
        """
        if target_size is None:
            target_size = (self.config.standard_size[1], self.config.standard_size[0])  # (H, W)
    ...
    def _resize_single_tensor(
        ...
        if strategy == "stretch":
            ...
            resized_pil = self.resize_pil_image(pil_image, (target_size[1], target_size[0]), strategy)
            return T.ToTensor()(resized_pil)
...
class StandardImageTransform:
    ...
    def _setup_transforms(self) -> None:
        ...
        transforms_list.append(
            lambda img: self.resizer.resize_pil_image(img, self.target_size, self.resize_strategy)
        )
        ...
        if self.augment:
            ...
            transforms_list = transforms_list[:-1] + augmentation_transforms + transforms_list[-1:]
