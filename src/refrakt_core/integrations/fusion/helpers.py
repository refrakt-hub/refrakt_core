...
def unpack_batch(batch: Union[Tuple, list, Dict[str, torch.Tensor]]) -> Tuple:
    """
...
def extract_features_from_model(model, x, device, teacher=False, **kwargs):
    """
...
def validate_model_output(output, require_embeddings=True):
    """
