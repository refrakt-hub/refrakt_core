...
def create_standard_transform(
    ...
    if resize_strategy == "maintain_aspect":
        resize_fn = lambda img: resize_image_maintain_aspect(img, target_size)
    elif resize_strategy == "crop":
        resize_fn = lambda img: resize_image_crop(img, target_size)
    elif resize_strategy == "stretch":
        resize_fn = lambda img: resize_image_stretch(img, target_size)
    else:
