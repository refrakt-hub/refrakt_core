...
class HyperparameterManager:
    ...
    def __init__(self, base_config: Optional[Union[Dict, DictConfig]] = None):
        """
    ...
    def add_validation_rule(self, path_pattern: str, validation_func: Callable) -> None:
        """
    ...
    def _apply_override(self, config: DictConfig, override: HyperparameterOverride) -> None:
    ...
    def load_config(self, filepath: Union[str, Path]) -> None:
        ...
        """
        self.base_config = OmegaConf.load(filepath)
...
def validate_model_type(value: Any) -> bool:
    ...
    valid_types = [
        'resnet', 'convnext', 'swin', 'vit', 'autoencoder', 'dino', 'mae', 'msn',
        'simclr', 'srgan', 'gan'
    ]
...
def create_learning_rate_override(value: float, description: Optional[str] = None) -> HyperparameterOverride:
...
def create_batch_size_override(value: int, description: Optional[str] = None) -> HyperparameterOverride:
...
def create_epochs_override(value: int, description: Optional[str] = None) -> HyperparameterOverride:
...
def create_device_override(value: str, description: Optional[str] = None) -> HyperparameterOverride:
