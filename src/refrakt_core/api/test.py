...
This module provides the main test function for evaluating trained models using the Refrakt
framework. It orchestrates the complete testing pipeline including model loading,
