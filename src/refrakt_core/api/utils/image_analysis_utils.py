...
This module provides utility functions for image analysis and resizing,
extracted from the main train_utils.py to reduce complexity.
"""
...
from refrakt_core.transforms.image_resizer import ImageSizeConfig, SmartImageResizer
...
def calculate_size_statistics(sizes: list) -> Tuple[float, float, int, int, int, int]:
    """
