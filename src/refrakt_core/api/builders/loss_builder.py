...
from refrakt_core.api.builders.utils.loss_utils import (
    _build_gan_style_loss, _build_multi_component_loss, _build_single_loss,
...
def build_loss(
    ...
    (generator/discriminator) losses. All losses are wrapped to ensure a standardized
    output format compatible with the training pipeline.
    ...
    Args:
        ...
        modules: Registry dictionary containing available loss functions and utilities
        device: Target device string (e.g., "cuda", "cpu") for loss function placement
