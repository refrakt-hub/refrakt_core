...
class TestTrainerBuilder:
    ...
    def test_initialize_trainer_smoke(
        self, base_cfg, model, loader, loss_fn, optimizer, scheduler, modules
    ):
    ...
    # Sanity Tests
    def test_initialize_trainer_sanity_params(
        self, base_cfg, model, loader, loss_fn, optimizer, scheduler, modules
    ):
    ...
    # Unit Tests
    def test_initialize_trainer_unit_missing_trainer_name(
        self, base_cfg, model, loader, loss_fn, optimizer, scheduler, modules
    ):
    ...
    def test_initialize_trainer_unit_params_not_dict(
        self, base_cfg, model, loader, loss_fn, optimizer, scheduler, modules
    ):
    ...
    def test_initialize_trainer_unit_invalid_cfg_type(
        self, model, loader, loss_fn, optimizer, scheduler, modules
    ):
        with pytest.raises(TypeError):
            initialize_trainer(
                "not_a_cfg",
