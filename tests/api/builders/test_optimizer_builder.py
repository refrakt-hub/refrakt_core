...
class TestOptimizerBuilder:
    ...
    def test_build_optimizer_unit_gan_style(self):
        cfg = OmegaConf.create({'optimizer': {'generator': {'name': 'adam', 'params': {'lr': 0.001}}, 'discriminator': {'name': 'adam', 'params': {'lr': 0.002}}}})
        model = DummyGAN()
    ...
    def test_build_optimizer_unit_multi_component(self):
        cfg = OmegaConf.create({'optimizer': {'components': {'a': {'name': 'adam', 'params': {'lr': 0.01}}, 'b': {'name': 'adam', 'params': {'lr': 0.02}}}}})
