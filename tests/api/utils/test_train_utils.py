...
class TestTrainUtils:
    ...
    def test_load_config_typeerror(self):
        # This test is skipped due to type checking issues with mocking OmegaConf
        pytest.skip("Type checking issues with OmegaConf mocking")

    def test_setup_logger(self):
        cfg = DictConfig({"runtime": {"log_type": ["file"], "log_dir": "./logs", "console": True, "debug": False}})
    ...
    def test_analyze_and_resize_dataset_images_empty(self):
        ...
        needs_resize, modified = train_utils.analyze_and_resize_dataset_images(ds, logger)
