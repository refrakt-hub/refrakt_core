...
def test_build_ml_pipeline_smoke():
    ...
    cfg = {
        ...
        'model': {'backend': 'sklearn', 'name': 'logistic_regression', 'params': {'max_iter': 100}}
    }
...
def test_build_ml_pipeline_with_validation_sanity():
    ...
    cfg = {
        ...
        'model': {'backend': 'sklearn', 'name': 'random_forest', 'params': {'n_estimators': 5}}
    }
    pipeline, model, X_out, y_out, X_val_out, y_val_out = build_ml_pipeline(cfg, X, y, X_val, y_val)
    assert pipeline is not None
...
def test_build_ml_pipeline_invalid_model_unit():
    ...
    cfg = {
        ...
        'model': {'backend': 'unknown_backend', 'name': 'logistic_regression', 'params': {}}
    }
