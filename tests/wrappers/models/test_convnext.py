...
def test_convnext_wrapper_sanity_forward_for_graph_returns_logits(
    mock_convnext, sample_input
):
...
def test_convnext_wrapper_unit_output_contains_logits_and_embeddings(
    mock_convnext, sample_input
):
...
def test_convnext_wrapper_unit_forward_calls_backbone_with_return_features(
    mock_convnext, sample_input
):
...
def test_convnext_wrapper_unit_forward_for_graph_calls_forward(
    mock_convnext, sample_input
):
...
def test_convnext_wrapper_unit_embeddings_and_logits_relationship(
    mock_convnext, sample_input
):
...
def test_convnext_wrapper_unit_lightweight_forward_for_graph(
    mock_convnext, sample_input
):
