...
def test_resnet_wrapper_sanity_forward_for_graph_returns_logits(mock_resnet, sample_input):
...
def test_resnet_wrapper_unit_output_contains_logits_and_embeddings(mock_resnet, sample_input):
...
def test_resnet_wrapper_unit_forward_calls_backbone_with_return_features(mock_resnet, sample_input):
...
def test_resnet_wrapper_unit_forward_for_graph_calls_backbone_directly(mock_resnet, sample_input):
